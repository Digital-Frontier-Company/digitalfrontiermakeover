        ...
        <CarouselContent>
          {slides.map((slide, index) => <CarouselItem key={index} className="relative min-w-full">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-[60vh] px-4 text-center">
                ...
                {slide.highlightText && <h1 className="text-5xl md:text-6xl mb-6 text-[var(--df-light-blue)] lg:text-7xl mx-0 my-[32px] px-[9px] py-[9px] font-extrabold text-cyan-400 border border-black">
                    {slide.highlightText}
                  </h1>}
