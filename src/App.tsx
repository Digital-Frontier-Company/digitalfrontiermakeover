      ...
      <QueryClientProvider client={queryClient}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/cookies" element={<MainLayout><div>Cookies Page</div></MainLayout>} />
            ...
            <Route path="/ai-bias-in-advertising" element={<MainLayout><div>AI Bias Page</div></MainLayout>} />
            <Route path="/ai-and-digital-marketing" element={<MainLayout><div>AI Marketing Page</div></MainLayout>} />
