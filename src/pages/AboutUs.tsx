...
const AboutUs = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Digital Frontier Company | AI Marketing Experts</title>
        <meta name="description" content="Learn about Digital Frontier Company - pioneers in AI-powered digital marketing, Answer Engine Optimization, and crypto marketing strategies. Meet our expert team." />
        <meta name="keywords" content="Digital Frontier Company, AI marketing experts, digital marketing agency, Answer Engine Optimization specialists, crypto marketing team, about us" />
        <link rel="canonical" href={canonicalUrl} />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="About Digital Frontier Company | AI Marketing Experts" />
        <meta property="og:description" content="Pioneers in AI-powered digital marketing and Answer Engine Optimization. Learn about our expert team and mission." />
        ...
        <meta name="twitter:title" content="About Digital Frontier Company" />
        <meta name="twitter:description" content="Pioneers in AI-powered digital marketing and Answer Engine Optimization." />
      ...
      <PageLayout 
        title="About Digital Frontier Company"
        subtitle="Pioneering the future of AI-powered digital marketing and optimization"
