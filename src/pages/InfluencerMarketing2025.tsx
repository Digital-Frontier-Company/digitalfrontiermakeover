...
const InfluencerMarketing2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      ...
      {/* Footer */}
      <footer className="relative bg-gray-950 text-gray-400 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              <h3 className="text-white text-xl font-bold mb-6">InfluenceX</h3>
              <p className="mb-6">Cutting-edge influencer marketing strategies for the digital-first creator economy of 2025 and beyond.</p>
              <div className="flex space-x-4">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="hover:text-white transition">Influencer Strategy</a></li>
                <li><a href="#" className="hover:text-white transition">Content Creation</a></li>
                <li><a href="#" className="hover:text-white transition">Agency Partnerships</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>22 Creator Lane, Digital City</span>
                </li>
                <li className="flex items-start">
                ...
                <li className="flex items-start">
                  ...
                  <span>hello@influencex.app</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p>© 2025 InfluenceX. All rights reserved.</p>
