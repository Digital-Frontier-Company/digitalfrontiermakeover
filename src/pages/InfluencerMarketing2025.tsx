...
const InfluencerMarketing2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans">
      ...
      {/* Navigation */}
      <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-sm sticky top-0 z-50 rounded-none py-[15px] px-[6px] mx-[3px] my-[3px] animate-fade-in">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-2 hover-scale">
              <img alt="Digital Frontier Company" src="/lovable-uploads/67d4ab65-6525-4a5d-801a-59264f47355b.png" className="max-h-24 transition-transform duration-300" />
            </Link>
            
            <div className="hidden md:flex items-center space-x-6">
              <Link to="/answer-engine-optimization" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-110 story-link">AEO</Link>
              <Link to="/generative-engine-optimization" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-110 story-link">GEO</Link>
              <Link to="/search-engine-optimization" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-110 story-link">SEO</Link>
              <Link to="/blog" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-110 story-link">Blog</Link>
              <Link to="/about" className="text-gray-300 hover:text-white transition-all duration-300 hover:scale-110 story-link">About</Link>
              ...
              <Link to="/contact" className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg hover:opacity-90 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25">Get Started</Link>
            </div>
        ...
        <div className="md:flex items-center gap-12">
          ...
          <div className="md:w-1/2">
            <div className="relative">
              ...
              <img src="https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Influencer marketing manager at work" className="rounded-2xl shadow-lg w-full object-cover" style={{minHeight: '400px'}} />
            </div>
          </div>
        </div>
      </section>
