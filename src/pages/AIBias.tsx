...
const AIBias = () => {
  ...
  return (
    <PageLayout 
      ...
      subtitle="Understanding and addressing bias in AI-powered marketing technologies is essential for ethical practice. Here are key issues and solutions:"
      currentPath={location.pathname}
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {biasTypes.map((item) => (
          <Card key={item.id} className="bg-slate-800/80 border-slate-700 hover:border-[#00BFFF] transition-colors group">
