...
const Index = () => {
  ...
  return (
    <MainLayout>
      ...
      <section className="df-hero-section relative overflow-hidden min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        {/* Background elements with blue effects */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600 rounded-full filter blur-3xl opacity-20 mix-blend-multiply"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-cyan-400 rounded-full filter blur-3xl opacity-20 mix-blend-multiply"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-600 rounded-full filter blur-3xl opacity-10 mix-blend-multiply"></div>
        </div>
        
        {/* Floating abstract shapes */}
        <div className="absolute top-20 left-10 w-16 h-16 rounded-lg bg-cyan-400 opacity-10 floating" style={{animationDelay: '0s'}}></div>
        <div className="absolute top-1/3 right-20 w-24 h-24 rounded-full bg-blue-600 opacity-10 floating" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-20 right-1/4 w-20 h-20 rounded-lg bg-cyan-400 opacity-10 floating" style={{animationDelay: '2s'}}></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="pt-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium flex items-center justify-center gap-2 text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            <Link to="/contact" className="btn-primary inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-cyan-400 rounded-lg hover:from-blue-500 hover:to-cyan-300 transition-all duration-300">
      ...
      {/* TestimonialsSection - This will use proper sizing from the component */}
      <TestimonialsSection />

      {/* SMART MARKETING SECTION */}
      <section className="df-smart-marketing" id="services">
        <div className="container">
          <div className="text-center mb-5">
            <img src="/lovable-uploads/a057b6bc-52ff-4437-92a0-6951b11267fe.png" alt="" width="60" className="mb-4" />
            <h2 className="text-white text-4xl font-bold">Smart Marketing Built for Speed, Scale, and Survival</h2>
          </div>

          <div className="intro-text" style={{maxWidth: "800px", margin: "0 auto 30px", textAlign: "center"}}>
            <p className="text-gray-300 text-lg mb-4">We're not another digital marketing agency tossing generic playbooks. We are The Digital Frontier Company, a crew of engineers, analysts, and creative killers who live to squeeze more money out of your pipeline.</p>
            <p className="text-gray-300 text-lg">Here's what Digital Frontier Marketing includes:</p>
          </div>
          ...
          <div className="row" style={{alignItems: "center"}}>
            <div className="col-lg-6">
              <div className="df-neon-border mt-3 mb-5 mb-lg-3">
                <img alt="Digital Frontier Data Dashboard" className="img-fluid p-2" style={{borderRadius: "10px"}} src="/lovable-uploads/8397f9b3-fc8b-4246-b8a6-166b26926970.png" />
              </div>
            </div>
            <div className="col-lg-6">
      ...
      <section className="df-what-youll-gain" style={{background: "linear-gradient(180deg, var(--df-black-blue) 0%, var(--df-dark-blue) 100%)", padding: "80px 0"}}>
        <div className="container">
          <div className="text-center mb-5">
            <img src="/lovable-uploads/a057b6bc-52ff-4437-92a0-6951b11267fe.png" alt="" width="60" className="mb-4" />
